...
import ContractCard from '@/components/saved-contracts/ContractCard';
import ContractStats from '@/components/saved-contracts/ContractStats';
import EmptyState from '@/components/saved-contracts/EmptyState';
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 sm:py-12">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground">Manage and view all your generated contracts</p>
          </div>
          <Link href="/">
